...
export default function Conteudo() {
  ...
  async function submeterProva() {
    ...
    try {
      ...
      const codigo = "ESTATISTICAI";

      const resp = await fetch("/api/provas/estatistica/p2", {
        method: "POST",
      ...
      // redireciona após 3s
      setTimeout(() => {
        router.push(`/resultados/anos/segundo/estatistica/${prova.id}`);
      }, 3000);
    } catch (error) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <header className="border-b pb-4">
        <h1 className="text-2xl font-bold">Prova de Estatistica </h1>
