...
export function setUserAssociation(): void {
  ...
  Disciplina.hasMany(UserDisciplina, { foreignKey: "disciplina_id", as: "UserDisciplina" });
  UserDisciplina.belongsTo(Disciplina, { as: "Disciplina", foreignKey: "disciplina_id" })
}
